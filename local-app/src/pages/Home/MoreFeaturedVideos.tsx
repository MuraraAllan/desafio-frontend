...
import { OutletItem, OutletItemMedium } from "../../components"
...
//     fetchNextPage,
//     hasNextPage,
//   } = useInfiniteQuery('video', ({ pageParam }) => fetchVideos(searchTerm, pageParam), {
//     getNextPageParam: (lastPage: any, allPages) => lastPage.data.nextPageToken, 
//     getPreviousPageParam: (firstPage, allPages) => firstPage.prevCursor,
//   })
//   const data = useQuery(['videos', searchTerm, page], () => fetchVideos(searchTerm),  { keepPreviousData : true })
//   console.log('DATA IS MOREFEATURED VIDEOS', data)
//   console.log('DATA HAS NEXT? ', hasNextPage)
  ...
  `
  return ( <MoreFeaturedFlexSection wrap={"wrap"} gap="10px"> 
      <FlexItem>
      ...
      <FlexItem>
        <OutletItemMedium
          isError={false} 
          imgURL={mockData.items[4].snippet.thumbnails.default.url} 
          title={mockData.items[4].snippet.title}
          desc={mockData.items[4].snippet.description}
        />
        </FlexItem>
      <OutletItemMedium
        isError={false} 
        imgURL={mockData.items[5].snippet.thumbnails.default.url} 
        title={mockData.items[5].snippet.title}
        desc={mockData.items[5].snippet.description}
      />
      <OutletItemMedium
        isError={false} 
        imgURL={mockData.items[6].snippet.thumbnails.default.url} 
        title={mockData.items[6].snippet.title}
        desc={mockData.items[6].snippet.description}
      />
      
      <OutletItemMedium
        isError={false} 
        imgURL={mockData.items[7].snippet.thumbnails.default.url} 
        title={mockData.items[7].snippet.title}
        desc={mockData.items[7].snippet.description}
      />
...
// {page > 1 ? <button onClick={() => setPage(page-1)}> oieee voltar </button> : null}
// {/* <button onClick={() => fetchNextPage()}> oieee avançar </button>  */}
